...
'installAndRestart''installAndRestart'tartMessagetartMessage: localize('install'installAndRestart'RestartMessage', "Install language pack to change the display language to {0}."),
   installAndRestart: localize('installAndRestart', "Install andand Restart")
}
```
